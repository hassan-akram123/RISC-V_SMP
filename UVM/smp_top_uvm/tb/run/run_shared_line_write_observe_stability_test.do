...
set TESTNAME shared_line_write_observe_stability_test
...
vsim -c -coverage -sv_seed 1 -onfinish stop -L mtiUvm work.tb_top   +UVM_NO_RELNOTES   +UVM_TESTNAME=${BASETEST}   +SMP_SCENARIO=${TESTNAME}   -do "do shared_line_write_observe_stability_test_inner.do"
