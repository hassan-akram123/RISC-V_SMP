...
vsim -c -coverage -sv_seed 1 -onfinish stop -L mtiUvm work.tb_top   +UVM_NO_RELNOTES   +UVM_TESTNAME=${TESTNAME}   -do "do boot_sanity_test_inner.do"
