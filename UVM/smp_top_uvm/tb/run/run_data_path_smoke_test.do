...
set TESTNAME data_path_smoke_test
...
vsim -c -coverage -sv_seed 1 -onfinish stop -L mtiUvm work.tb_top   +UVM_NO_RELNOTES   +UVM_TESTNAME=${TESTNAME}   -do "do data_path_smoke_test_inner.do"
