...
set TESTNAME symmetric_store_ping_pong_test
...
vsim -c -coverage -sv_seed 1 -onfinish stop -L mtiUvm work.tb_top       +UVM_NO_RELNOTES       +UVM_TESTNAME=${BASETEST}       +SMP_SCENARIO=${TESTNAME}       -do "do symmetric_store_ping_pong_test_inner.do"
