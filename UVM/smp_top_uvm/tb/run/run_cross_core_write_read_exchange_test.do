...
set TESTNAME cross_core_write_read_exchange_test
...
vsim -c -coverage -sv_seed 1 -onfinish stop -L mtiUvm work.tb_top   +UVM_NO_RELNOTES   +UVM_TESTNAME=${BASETEST}   +SMP_SCENARIO=${TESTNAME}   -do "do cross_core_write_read_exchange_test_inner.do"
