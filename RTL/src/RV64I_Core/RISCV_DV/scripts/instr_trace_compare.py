            ...
            for trace in instr_trace_1:
                ...
                while gpr_state_change_2 == 0 and trace_2_index < len(instr_trace_2):
                    gpr_state_change_2 = check_update_gpr(
                        instr_trace_2[trace_2_index].gpr, gpr_val_2
                    )
                    trace_2_index += 1
...
def main():
    ...
    parser.add_argument("--in_order_mode", type=int, default=1, help="In order comparison mode")
    parser.add_argument(
    ...
    parser.add_argument("--mismatch_print_limit", type=int, default=5, help="Max number of mismatches printed")
    parser.add_argument("--verbose", type=int, default=0, help="Verbose logging")
    parser.add_argument("--compare_final_value_only", type=int, default=0, help="Only compare the final value of the GPR")
    ...
    # IMPORTANT: propagate failure to shell / regression.py
